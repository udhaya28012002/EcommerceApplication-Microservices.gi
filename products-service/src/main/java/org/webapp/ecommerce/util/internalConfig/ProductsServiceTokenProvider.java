...
@Component
public class ProductsServiceTokenProvider {

    private static final Logger log = LoggerFactory.getLogger(ProductsServiceTokenProvider.class);
    ...
    public ProductsServiceTokenProvider(TokenProperties tokenProperties, InitAllowedServicesProperties initAllowedServicesProperties) {
