...
@Component
public class ProductsAPITokenProvider {

    private static final Logger log = LoggerFactory.getLogger(ProductsAPITokenProvider.class);
    ...
    public ProductsAPITokenProvider(TokenProperties tokenProperties) {
