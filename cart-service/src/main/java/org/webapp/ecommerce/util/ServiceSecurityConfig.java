...
public class ServiceSecurityConfig {
    ...
    public ServiceSecurityConfig(
            @Qualifier("serviceTokenFilter") ServiceTokenFilter serviceAuthFilter,
            @Qualifier("apiTokenFilter") APITokenFilter apiAuthFilter,
    ...
    public SecurityFilterChain internalFilterChain(HttpSecurity httpSecurity) throws Exception{
        ...
        httpSecurity
                .securityMatcher("/api/cart/internal/**")
                .csrf(csrf -> {
    ...
    public SecurityFilterChain apiFilterChain(HttpSecurity httpSecurity) throws Exception{
        ...
        log.info("Configuring Spring Security filter chain for API Request");
