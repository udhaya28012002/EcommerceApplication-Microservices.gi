...
public class UtilBeans {
    ...
    @Bean("apiTokenFilter")
    public APITokenFilter apiTokenFilter(CartAPITokenProvider apiTokenProvider){
    ...
    public ServiceTokenFilter serviceTokenFilter(CartServiceTokenProvider cartServiceTokenProvider){
