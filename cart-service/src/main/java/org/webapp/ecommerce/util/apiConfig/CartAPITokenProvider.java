...
@Component
public class CartAPITokenProvider {

    private static final Logger log = LoggerFactory.getLogger(CartAPITokenProvider.class);
    ...
    public CartAPITokenProvider(TokenProperties tokenProperties) {
