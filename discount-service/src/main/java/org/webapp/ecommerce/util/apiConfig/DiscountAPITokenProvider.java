...
@Component
public class DiscountAPITokenProvider {

    private static final Logger log = LoggerFactory.getLogger(DiscountAPITokenProvider.class);
    ...
    public DiscountAPITokenProvider(TokenProperties tokenProperties) {
