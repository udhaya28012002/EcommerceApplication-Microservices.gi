...
@Component
public class DiscountServiceTokenProvider {

    private static final Logger log = LoggerFactory.getLogger(DiscountServiceTokenProvider.class);
    ...
    public DiscountServiceTokenProvider(TokenProperties tokenProperties, InitAllowedServicesProperties initAllowedServicesProperties) {
