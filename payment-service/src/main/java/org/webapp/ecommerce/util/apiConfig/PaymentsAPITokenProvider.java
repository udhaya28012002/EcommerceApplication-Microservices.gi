...
@Component
public class PaymentsAPITokenProvider {

    private static final Logger log = LoggerFactory.getLogger(PaymentsAPITokenProvider.class);
    ...
    public PaymentsAPITokenProvider(TokenProperties tokenProperties) {
