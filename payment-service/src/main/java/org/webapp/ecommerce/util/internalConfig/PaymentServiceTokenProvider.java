...
public class PaymentServiceTokenProvider {
    ...
    private static final Logger log = LoggerFactory.getLogger(PaymentServiceTokenProvider.class);
    ...
    public PaymentServiceTokenProvider(TokenProperties tokenProperties, InitAllowedServicesProperties initAllowedServicesProperties) {
