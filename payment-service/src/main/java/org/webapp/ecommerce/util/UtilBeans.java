...
public class UtilBeans {
    ...
    public ServiceTokenFilter serviceTokenFilter(PaymentServiceTokenProvider paymentServiceTokenProvider) {
        return new ServiceTokenFilter(paymentServiceTokenProvider);
    }
    ...
    // ── Add this for @Order(3) API chain ─────────────────────────────────────
    @Bean("apiTokenFilter")
    public APITokenFilter apiTokenFilter(PaymentsAPITokenProvider paymentAPITokenProvider) {
        return new APITokenFilter(paymentAPITokenProvider);
    }
