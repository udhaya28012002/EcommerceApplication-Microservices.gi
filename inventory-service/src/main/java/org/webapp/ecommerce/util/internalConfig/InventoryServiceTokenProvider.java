...
@Component
public class InventoryServiceTokenProvider {

    private static final Logger log = LoggerFactory.getLogger(InventoryServiceTokenProvider.class);
    ...
    public InventoryServiceTokenProvider(TokenProperties tokenProperties, InitAllowedServicesProperties initAllowedServicesProperties) {
