...
import org.webapp.ecommerce.util.apiConfig.InventoryAPITokenProvider;
import org.webapp.ecommerce.util.internalConfig.InventoryServiceTokenProvider;
...
public class UtilBeans {
    ...
    @Bean("apiTokenFilter")
    public APITokenFilter apiTokenFilter(InventoryAPITokenProvider apiTokenProvider){
    ...
    public ServiceTokenFilter serviceTokenFilter(InventoryServiceTokenProvider cartServiceTokenProvider){
