...
@Component
public class InventoryAPITokenProvider {

    private static final Logger log = LoggerFactory.getLogger(InventoryAPITokenProvider.class);
    ...
    public InventoryAPITokenProvider(TokenProperties tokenProperties) {
