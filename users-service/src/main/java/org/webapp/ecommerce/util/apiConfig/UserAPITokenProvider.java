...
@Component
public class UserAPITokenProvider {

    private static final Logger log = LoggerFactory.getLogger(UserAPITokenProvider.class);
    ...
    public UserAPITokenProvider(TokenProperties tokenProperties) {
        this.tokenProperties = tokenProperties;
        this.key = Keys.hmacShaKeyFor(tokenProperties.getSecret().getBytes(StandardCharsets.UTF_8));
    }

    public String generateAPIToken(String username, String role) {
