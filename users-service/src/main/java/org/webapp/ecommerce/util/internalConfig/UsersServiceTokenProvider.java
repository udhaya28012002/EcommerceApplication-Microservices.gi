...
@Component
public class UsersServiceTokenProvider {

    private static final Logger log = LoggerFactory.getLogger(UsersServiceTokenProvider.class);
    ...
    public UsersServiceTokenProvider(TokenProperties tokenProperties, InitAllowedServicesProperties initAllowedServicesProperties) {
