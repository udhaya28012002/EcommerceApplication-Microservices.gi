...
public class APITokenFilter extends OncePerRequestFilter {
    ...
    private final UserAPITokenProvider tokenProvider;

    public APITokenFilter(UserAPITokenProvider tokenProvider) {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (request.getServletPath().equals("/api/auth/refreshAuth")) {
