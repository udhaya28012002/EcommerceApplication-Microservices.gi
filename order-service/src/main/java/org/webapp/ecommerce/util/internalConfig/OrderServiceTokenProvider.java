...
public class OrderServiceTokenProvider {
    ...
    private static final Logger log = LoggerFactory.getLogger(OrderServiceTokenProvider.class);
    ...
    public OrderServiceTokenProvider(TokenProperties tokenProperties, InitAllowedServicesProperties initAllowedServicesProperties) {
